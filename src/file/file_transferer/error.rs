...
impl Display for FileTransfererError {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> Result<(), std::fmt::Error> {
        match self {
            ...
            Self::FileReadError(e) => write!(f, "Error: \"Error while reading a file\". Details: {}", e),
            Self::FileWriteError(e) => write!(f, "Error: \"Error while writing a file\". Details: {}", e),            
            Self::FileCreateError(e) => write!(f, "Error: \"Error while creating a file\". Details: {}", e), 
            Self::ChannelSendError(e) => write!(f, "Error: \"DataChannel send failed\". Details: {}", e),
