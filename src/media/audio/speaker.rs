...
impl Speaker {
    ...
    pub fn new(logger: Logger, sample_rate: u32) -> Result<Self, String> {
        ...
        logger.info(&format!("Parlante nativo: {}Hz, {} canales.", output_rate, output_channels));
        ...
        let stream = device.build_output_stream(
            ...
            move |err| {
                logger_cl.error(&format!("Speaker error: {}", err));
            },
            None
