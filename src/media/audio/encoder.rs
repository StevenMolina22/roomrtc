...
impl AudioEncoder {
    pub fn new() -> Result<Self, Error> {
        let encoder = Encoder::new(SampleRate::Hz48000, Channels::Mono, Application::Voip).map_err(|_| Error::EncoderInitializationError)?;
    ...
    pub fn encode(&mut self, audio_frame: AudioFrame) -> Result<Vec<u8>, Error> {
        ...
        let len = self.encoder.encode_float(&input_samples, &mut buff)
